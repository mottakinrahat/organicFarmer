...
const BannerCom = ({ upText, title, paratext,img,smText }) => {
    const bannerImgUrl = {img};
    return (
        <div className='mb-[84px]'>
            <div className="hero h-[447px] w-full md:h-[680px]" style={{
                    ...
                    <div className="hero-content  text-white">
                        <div className="max-w-full md:flex md:gap-[168px]">
                            <div className='md:mr-20 mt-20'>
                                ...
                                <button className='md:py-[12px] mb-2 py-[7px] md:px-[40px] px-[6.5px] bg-[#159122] rounded-xl text-white flex items-center mt-4 gap-2 '>Join Our Community</button>
                            </div>
