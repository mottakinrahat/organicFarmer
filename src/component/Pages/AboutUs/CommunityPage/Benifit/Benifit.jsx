...
const Benifit = () => {
    return (
        <div className=''>
            ...
            <div className='md:flex sm:grid sm:grid-cols-2 justify-evenly gap-4 items-center  mt-[40px]'>
                <div className='bg-[#E8F0CA] w-[325px] h-[234px] p-[24px] mx-auto mb-3 rounded-xl'>
