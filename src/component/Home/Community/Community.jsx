...
const Community = () => {
    return (
        <div className=' md:h-[820px] py-6 md:py-0 bg-[#C4D290] md:mx-[40px] rounded-xl mb-10 md:pb-[96px]'>
            <div className='md:h-[632px]  md:mx-[40px] mx-[20px] rounded-xl md:mb-[96px] mb-10 '>
                ...
                <div className='md:flex justify-between items-center md:px-[48px] '>
                    ...
                    <div className='md:w-[584px]'>
                        ...
                        <p className='mb-[40px] text-[18px]'>On our exclusive community platform, serious growers like yourself come together to meet and support one another, get answers and advice, learn from the experts, participate in growth challenges, access exclusive offers from our partners, and more.</p>
